...
def _render_pdf(path, portfolio_name, curve_date, scenario_results, base_zc_data):
    ...
    C_POS = (45, 155, 117)
    C_NEG = (235, 115, 85)
    SITE_URL = "https://bondfactor.sourabhpradhan.in"
    ...
    class StyledPDF(FPDF):
        ...
        def footer(self):
            ...
            self.cell(half, 5, "bondfactor.sourabhpradhan.in", align="R", link=SITE_URL, new_x="LMARGIN", new_y="NEXT")
    ...
    pdf.ln(2)
    pdf.set_text_color(*C_ACCENT)
    pdf.cell(0, 5, "bondfactor.sourabhpradhan.in", align="C", link=SITE_URL, new_x="LMARGIN", new_y="NEXT")
    pdf.ln(2)
    pdf.set_text_color(*C_DIM)
